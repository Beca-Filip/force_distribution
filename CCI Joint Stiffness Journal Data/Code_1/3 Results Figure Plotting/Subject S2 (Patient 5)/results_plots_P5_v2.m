...
figure_2_v1(P5,'CCI_1')
figure_2_v1(P5,'CCI_2')
                        ...
                        for j = 1:3 %  number of DoFs
                            switch j
                                ...
                                case 2 % KneeFE
                                    ...
                                    CCI = CCI.L_KneeFE(:,:,CCI_1_idx.L_KneeFE(idx_best));
                                ...
                                case 3 % AnkleFE
                                    ...
                                    CCI = Inpt.CCI_e_delayed.L_AnkleFE(:,:,CCI_1_idx.L_AnkleFE(idx_best));
                        ...
                        for j = 1:3
                            switch j
                                ...
                                case 2 % KneeFE
                                    ...
                                    CCI = CCI.R_KneeFE(:,:,CCI_2_idx.R_KneeFE(3));
