...
speed_strings = arrayfun(@(n) sprintf("Speed=$$%.2f \\frac{\\textrm{m}}{\\textrm{s}}$$", speeds(n)), 1:5, 'UniformOutput', false);
tick_locations = 1:5;
...
for leg_select = [1, 2]
for phase_select = [1, 2]
    exportgraphics(figure(cnt), sprintf('../../bilevel_optim_results/job_ioc_results/patient5/theta-vs-speed-leg-%d-phase-%d.pdf', leg_select, phase_select), 'ContentType', 'vector');
    exportgraphics(figure(cnt), sprintf('../../bilevel_optim_results/job_ioc_results/patient5/theta-vs-speed-leg-%d-phase-%d.png', leg_select, phase_select), 'ContentType', 'image', 'Resolution', 300);
    cnt = cnt + 1;
end
end
...
% Save figures
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/rmse-vs-speed.pdf'), 'ContentType', 'vector');
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/rmse-vs-speed.png'), 'ContentType', 'image', 'Resolution', 300);
...
% Save figures
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/force-vs-time-leg-1.pdf'), 'ContentType', 'vector');
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/force-vs-time-leg-1.png'), 'ContentType', 'image', 'Resolution', 300);
...
plotQuantilesAndPredictions(2, 3, 2, data, predictedRmsesPerTrial, predictedForces);
TileFigures;

% Save figures
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/force-vs-time-leg-2.pdf'), 'ContentType', 'vector');
exportgraphics(gcf, sprintf('../../bilevel_optim_results/job_ioc_results/patient5/force-vs-time-leg-2.png'), 'ContentType', 'image', 'Resolution', 300);