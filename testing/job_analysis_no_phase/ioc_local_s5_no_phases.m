...
for speed_list = 3
    ...
    % Compute solution
    fprintf("Computing IOC Speed %d Leg %d.\n", speed_list, leg_list);
    ...
    % Save solution
    save(sprintf("ios5/whole-cycle-speed-%d-leg-%d.mat", speed_list, leg_list), "alpha", "err", "exflg", "out", "lam", "grad", "hess", "sample_list", "trial_list", "speed_list", "leg_list");
end
end