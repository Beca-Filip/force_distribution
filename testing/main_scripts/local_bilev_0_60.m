...
bilevel_results_dir = '..\..\bilevel_optim_results/diff_normalized_grid_search/local-15-functions-0-60.mat';
...
clearvars -except alpha_bilev E_loc alpha_loc
...
% predictions
swing_phase_results.Fout_KKT = Fout_KKT;
swing_phase_results.Fout_bilevel = Fout_bilevel;

% indexing
swing_phase_results.indexing_list = indexing_list;
swing_phase_results.cf_exclude = cf_exclude;

% weight retrieval
swing_phase_results.solio = solio;
swing_phase_results.alpha_bilev = alpha_bilev;

% Save the
save('../../bilevel_optim_results/bilev_kesh_comparison/local_bilev_vs_kesh_0_60.mat', 'swing_phase_results');