function [model, vars] = form_casadi_model_normalized_s5(varargin)
%FORM_CASADI_MODEL_NORMALIZED_S5 creates a casadi opti stack with cost
%functions from the basis and integrating normalization (specialized for
%subject 5).
%   
%   [model, vars] = FORM_CASADI_MODEL_NORMALIZED_S5()
