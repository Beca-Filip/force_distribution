function [err, alpha] = IO_grid_search_normalized(Ngrid, data, vars, model, sample_list, trial_list, speed_list, leg_list)
...
for ii = 1 : size(alpha, 1)
    ...
    err(ii) = IO_inner_loop_normalized(alpha(ii, :).', data, vars, model, sample_list, trial_list, speed_list, leg_list);
